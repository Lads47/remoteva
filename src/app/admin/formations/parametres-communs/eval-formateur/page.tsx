...
// Éditeur du questionnaire d'éval formateur GLOBAL.
...
export default function TrainerEvalConfigPage() {
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm font-jetbrains mt-1" style={{ color: "#727485" }}>
          Envoyée automatiquement au formateur <strong>le lendemain de la fin de session</strong>, avec relances
          à J+7 et J+14. Édite ici le set de questions <strong>global</strong> utilisé par défaut.
          Le type <code>likert_4</code> (échelle 1 à 4 sans neutre) est disponible pour les questions où on veut
          forcer le formateur à se positionner positif ou négatif.
        </p>
      </div>
