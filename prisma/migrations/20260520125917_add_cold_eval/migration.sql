-- CreateTable
CREATE TABLE "cold_eval_responses" (
    ...
    CONSTRAINT "cold_eval_responses_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "formation_sessions" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "cold_eval_responses_trainee_id_fkey" FOREIGN KEY ("trainee_id") REFERENCES "trainees" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);

-- CreateTable
CREATE TABLE "cold_eval_answers" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "response_id" TEXT NOT NULL,
    "question_name" TEXT NOT NULL,
    "value" TEXT NOT NULL,
    CONSTRAINT "cold_eval_answers_response_id_fkey" FOREIGN KEY ("response_id") REFERENCES "cold_eval_responses" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "cold_eval_responses_magic_token_key" ON "cold_eval_responses"("magic_token");

-- CreateIndex
CREATE INDEX "cold_eval_responses_session_id_idx" ON "cold_eval_responses"("session_id");

-- CreateIndex
CREATE INDEX "cold_eval_responses_trainee_id_idx" ON "cold_eval_responses"("trainee_id");

-- CreateIndex
CREATE INDEX "cold_eval_responses_magic_token_idx" ON "cold_eval_responses"("magic_token");

-- CreateIndex
CREATE INDEX "cold_eval_responses_submitted_at_idx" ON "cold_eval_responses"("submitted_at");

-- CreateIndex
CREATE UNIQUE INDEX "cold_eval_responses_session_id_trainee_id_key" ON "cold_eval_responses"("session_id", "trainee_id");

-- CreateIndex
CREATE INDEX "cold_eval_answers_response_id_idx" ON "cold_eval_answers"("response_id");
